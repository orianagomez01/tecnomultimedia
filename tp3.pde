...
PImage imagencreditos, imagenrepuesto, chicossaltando, imagennenesasustados,imagensillaman, imagenmadrellegando, imagengatofondo, imagengatointentandoreparar, imagenauto; 
...
chicossaltando = loadImage ("chicossaltando.png");
